    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-[#0F2651] mb-2">Database Browser</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          {message && (
            <div className={`mt-4 p-3 rounded ${connectionStatus === 'error' ? 'bg-red-50 text-red-700' : 'bg-green-50 text-green-700'}`}>
              {message}
            </div>
          )}
        </CardContent>
