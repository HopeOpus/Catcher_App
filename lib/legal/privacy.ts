      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              "Wallet and referral data",
              "Your credit balance, wallet transaction history, credit expiry dates, transfers sent and received, your referral code, the accounts attached to it, referral qualification status and milestone awards.",
              "Generated by our systems from your activity and that of people you refer.",
            ],
            [
              "Referral integrity signals",
              "Email address, phone number and device installation identifier, compared between a referring and a referred account to detect self-referral and duplicate accounts.",
              "Collected automatically when a referral code is attached to a new account.",
            ],
            [
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              "Running the wallet and referral programme",
              "Wallet and referral data",
              "Performance of our contract with you",
            ],
            [
              "Detecting self-referral and referral abuse",
              "Referral integrity signals",
              "Our legitimate interest in protecting the integrity of a promotional programme",
            ],
            [
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              "Registry search, signed out (/search-registry)",
              "Item name, category, serial number, registration date, description, photograph, whether the item is reported stolen, and the registrant name and profile photograph.",
              "Registrant email, phone number, NIN and next-of-kin details.",
            ],
            [
              "Registry search, signed in (/search-registry)",
              "Everything above, plus the registrant email address and phone number so you can contact them about a specific item.",
              "Registrant NIN and next-of-kin details.",
            ],
          ],
        },
        {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              "Wallet ledger and referral records",
              "At least 6 years from the end of the relevant financial year, because the wallet is a financial ledger and referral awards must remain auditable.",
            ],
            [
